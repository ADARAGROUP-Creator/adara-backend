# CLAUDE.md — Reglas del repo ADARA

> Este archivo lo lee Claude Code automáticamente al abrir el repo.
> `AGENTS.md` es su gemelo para Codex y dice **lo mismo**. Si cambiás una regla acá, cambiala allá.
...
Somos dos personas con dos agentes distintos (Claude Code y Codex) sobre el mismo repo.
